...
type Props = NativeStackScreenProps<RootStackParamList, "ToSrecheck">;

const ToSrecheckScreen = ({navigation}: Props) => {
  ...
  return (
    <Box flex={1} bg={nativeBaseColorMode === 'light' ? 'coolGray.50' : 'coolGray.900'}>
      <Box pt={8} bg={nativeBaseColorMode === 'light' ? 'coolGray.50' : 'coolGray.900'}/>
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        <VStack space={1}>
          ...
          <BodyText>未成年者が本アプリを利用する場合、親権者等の法定代理人の同意を得たうえで利用するものとします。</BodyText>
          ...
          <BodyText>・異性との出会いや交際、または公序良俗に反する接触を目的として本アプリを利用する行為。</BodyText>
          ...
          <HeadingText>第4条（利用制限および登録抹消）</HeadingText>
          <BodyText>当方は、ユーザーが本規約のいずれかに違反した場合、または違反するおそれがあると判断した場合、事前の通知なく、当該ユーザーの利用制限またはアカウント登録の抹消を行うことができるものとします。</BodyText>

          <HeadingText>第5条（知的財産権）</HeadingText>
          <BodyText>本アプリに関する著作権その他の知的財産権は、すべて当方または当方にライセンスを許諾している者に帰属します。</BodyText>

          <HeadingText>第6条（本アプリの提供の停止等）</HeadingText>
          <BodyText>当方は、システムの保守、天災、その他不可抗力により本アプリの提供が困難と判断した場合、ユーザーに事前に通知することなく本アプリの全部または一部の提供を停止または中断できるものとします。</BodyText>

          <HeadingText>第7条（免責事項）</HeadingText>
          ...
          <HeadingText>第8条（サービス内容の変更等）</HeadingText>
          <BodyText>当方は、本アプリの内容を変更し、または提供を中止することができるものとします。重要な変更を行う場合は、本アプリ内または当方が適当と判断する方法で事前にお知らせします。</BodyText>

          <HeadingText>第9条（利用規約の変更）</HeadingText>
          <BodyText>当方は、必要と判断した場合には本規約を変更できるものとします。重要な変更を行う場合は、事前にユーザーへ通知するものとし、変更後、本アプリを利用したユーザーは変更後の規約に同意したものとみなします。</BodyText>

          <HeadingText>第10条（反社会的勢力の排除）</HeadingText>
          ...
          <HeadingText>第11条（準拠法・裁判管轄）</HeadingText>
...
export default ToSrecheckScreen